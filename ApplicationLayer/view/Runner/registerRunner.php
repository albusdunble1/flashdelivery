  ...
  <form action="" method="POST" enctype="multipart/form-data">
	<div class="loginboxrunner">
      ...
      <div class="containar">
			...
			<div class="fillbox1">
				<input type="text" placeholder="Name" name="RunnerName"></div>

			<div class="fillbox1"><input type="email" placeholder="Email" name="RunnerEmail" required></div>
      ...
      <div class="fillbox1"><input type="text" placeholder="Address" name="RunnerAddress" required></div>

      <div class="fillbox1"><input type="text" placeholder="Plate No" name="RunnerPlateNo" required></div>
