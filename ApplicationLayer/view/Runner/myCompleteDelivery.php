...
for($p = 0; $p < count($orderproductID); $p++) {
      $CompleteOrder = $product->viewMyCompleteDelivery($orderproductID,$p);
      $CompleteOrders = $CompleteOrder->fetch();
      if($CompleteOrders[0] != ''){
      $orderproductid[] = $CompleteOrders[0];
    }
  }
...
for($j = 0; $j<count($orderproductid);$j++) {
    ...
    // $item = $product->viewDeliveryItem($orderid,$j);
...
<html lang="en" dir="ltr">
   <html lang="en" dir="ltr">
      <head>
         ...
         <title>My Complete Delivery</title>
      </head>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-info" style="height:50px">
        <div class="collapse navbar-collapse" id="navbarColor01">
          <div class="navbar-nav">
            ...
            <a class="nav-item nav-link active" href="myCompleteDelivery.php">COMPLETE DELIVERY<span class="sr-only">(current)</span></a>
            ...
            <div class="row">
               <div class="col-md-12">
                 <div style="text-align:center;">
                   <h3 align="center">My Complete Delivery</h3>
                    <i  class="fa fa-check fa-3x" aria-hidden="true" style="color:#1fa67a"></i>
                 </div><br>
                    ...
                    <div id="container">
                     <!-- <form id="delivery-form" method="post"> -->
                        <table class="table table-striped" id="myDeliveryTable">
                                       ...
                                       <div class="modal-content">
                                         ...
                                         <div class="modal-body">
                                           ...
                                           <p><span style="font-weight:bold">Order Date: </span><?=$orderDate[$x]?></p>
                                            <p style="color:green"><span style="font-weight:bold">Delivery Status: </span><?=strtoupper($deliveryStatus[$x])?></p>
                                         </div>
                          ...
                          if($value != 0){
                           ?>
                              <button type="button" id="myDelivery" class="btn btn-warning" onclick="window.location.href='myDeliveryList.php'">View My Pending Delivery<span class="badge badge-danger ml-2"><?= $value ?></span></button>
                            </div>
                            <?php
                                }
                             ?>
