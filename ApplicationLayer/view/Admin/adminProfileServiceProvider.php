<?php
// Author: Firdaus
// Page to dispay a single service provider profile details for admin
require_once '../../../libs/adminSession.php';
require_once '../../../BusinessServiceLayer/controller/adminProfileController.php';
$servicProvider = new adminProfileController();
$data = $servicProvider->serviceProvider();
?>
    ...
    <div id="customer-profile">
      <div id="customer-nav" class="text-center">
        ...
        <div class="border w-100 py-2">
          <a class="active" href="adminValidateServiceProvider.php"><i class="fa fa-angle-double-left" aria-hidden="true"></i>
            Back</a>
        </div>
