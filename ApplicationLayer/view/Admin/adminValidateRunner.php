<?php
// Author: Firdaus
// Page to display all runners details and for admin to approve/reject the runners
...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="adminValidateServiceProvider.php">Service Providers</a>
          </li>
  ...
  <div class="container">
    <h2 class="text-center mb-3">Runners List</h2>
    <table class="table">
      <thead class="thead-dark">
        <tr>
        <th scope="no">No</th>
          <th scope="col">RunnerID</th>
        ...
        <tbody>
          <form action="" method="post">
            <tr>
              ...
              <th scope="row"><?php echo $runner->RunnerID ?></th>
              <td><?php echo $runner->RunnerEmail ?></td>
              <td><?php echo $runner->RunnerICNo ?></td>
              <td><?php echo $runner->RunnerPlateNo ?></td>
              <td>
                <select class="form-control form-control-sm" name="reg_status">
                  <option selected value="<?php echo $runner->RunnerRegStatus; ?>"> <?php echo $runner->RunnerRegStatus; ?></option>
                  <option value="REJECTED"> Reject</option>
                  <option value="APPROVED"> Approve</option>
                </select>
              </td>
              <td><input type="text" name="reg_comment" class="form-control form-control-sm " value="<?php echo $runner->RunnerRegComment; ?>"></td>
              <input type="hidden" name="id" value="<?php echo $runner->RunnerID ?>">
              <td> <input type="submit" value="Save" class="btn btn-success btn-block"></td>
              <td> <a href="adminProfileRunner.php?id=<?php echo $runner->RunnerID ?>" class=" btn btn-info btn-block">More</td>
            </tr>
          </form>
